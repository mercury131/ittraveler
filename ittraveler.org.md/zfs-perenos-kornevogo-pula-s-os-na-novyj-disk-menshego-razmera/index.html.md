...
Related posts:Восстановление пароля root на сервере MysqlУстановка и настройка AnsibleУстановка и настройка Radius сервера на Ubuntu с веб интерфейсом.
 Linux 
