...
Related posts:Автоматизация создания адресных книг в Office 365 через Powershell Часть 1.Active Directory + Thunderbird = Общая адресная книгаОбновление Lync 2013 до Skype for Business
        
             Active Directory, Office 365, PowerShell, Windows, Windows Server 
             Метки: Active Directory, Office 365, sync Office 365  
