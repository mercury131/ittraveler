...
&nbsp;
&nbsp;
Related posts:Установка и настройка Citrix XenServer Часть 1.Установка и настройка Citrix XenServer Часть 2.LVM Добавляем место на диске в виртуальной среде
