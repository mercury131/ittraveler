...
&nbsp;
&nbsp;
Related posts:Поиск старых почтовых ящиков в Exchange 2010Сброс пароля компьютера в домене без перезагрузкиАудит DNS серверов на Windows Server 2008 R2 через Powershell
