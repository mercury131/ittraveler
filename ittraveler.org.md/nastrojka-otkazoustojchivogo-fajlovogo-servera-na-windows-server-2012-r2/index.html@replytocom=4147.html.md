...
&nbsp;
&nbsp;
Related posts:Подключение к Office 365 через Powershell и зашифрованный парольАудит DNS серверов на Windows Server 2008 R2 через PowershellУправление репликацией Active Directory
