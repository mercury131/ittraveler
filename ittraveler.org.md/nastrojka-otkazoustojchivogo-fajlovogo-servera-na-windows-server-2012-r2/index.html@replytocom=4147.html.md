...
&nbsp;
&nbsp;
Related posts:Автоматизация создания адресных книг в Office 365 через Powershell Часть 2Создание email рассылки через PowershellПеренос базы данных Active Directory
