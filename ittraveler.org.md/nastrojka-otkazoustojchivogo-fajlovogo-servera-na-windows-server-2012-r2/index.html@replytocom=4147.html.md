...
&nbsp;
&nbsp;
Related posts:Windows WSL подключение к сетевым шарамНастройка Kerberos авторизации в Apache2Аудит DNS серверов на Windows Server 2008 R2 через Powershell
