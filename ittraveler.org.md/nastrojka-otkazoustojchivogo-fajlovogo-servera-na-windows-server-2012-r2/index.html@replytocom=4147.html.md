...
&nbsp;
&nbsp;
Related posts:Аудит DNS серверов на Windows Server 2008 R2 через PowershellОтказоустойчивый ISCSI кластер на Windows Server 2012 R2Перенос базы данных Active Directory
