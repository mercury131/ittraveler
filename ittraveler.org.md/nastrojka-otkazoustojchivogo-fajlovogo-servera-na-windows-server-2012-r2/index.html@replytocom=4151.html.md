...
&nbsp;
&nbsp;
Related posts:Автоматизация создания адресных книг в Office 365 через Powershell Часть 1.Настройка Kerberos авторизации в Apache2Создание шаблонов Zabbix для Windows.
