...
&nbsp;
&nbsp;
Related posts:Создание шаблонов Zabbix для Windows.Включение корзины Active DirectoryПринудительная синхронизация контроллеров домена Active Directory
