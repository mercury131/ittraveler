...
 
 
Related posts:Удаляем неисправный контроллер домена при помощи утилиты NTDSUTILСоздание email рассылки через PowershellАудит DNS серверов на Windows Server 2008 R2 через Powershell
