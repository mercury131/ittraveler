...
 
 
Related posts:Назначение служб для сертификатов Exchange через Powershell.Установка и настройка AnsibleЭкспорт почтовых ящиков Exchange 2010 через Powershell и PST
