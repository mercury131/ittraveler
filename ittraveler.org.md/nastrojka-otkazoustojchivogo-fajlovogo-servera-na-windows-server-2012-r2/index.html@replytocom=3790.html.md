...
 
 
Related posts:Автоматическая активация пользователей Lync через PowershellСоздание email рассылки через PowershellКак узнать WWN (World Wide Name)  в Windows Server 2012R2
