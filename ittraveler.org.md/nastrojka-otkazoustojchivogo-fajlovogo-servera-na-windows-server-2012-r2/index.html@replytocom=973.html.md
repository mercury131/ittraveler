...
&nbsp;
&nbsp;
Related posts:Обновление Lync 2013 до Skype for BusinessАудит изменений групповых политик через PowerShellНовые компьютеры не появляются на WSUS сервере
