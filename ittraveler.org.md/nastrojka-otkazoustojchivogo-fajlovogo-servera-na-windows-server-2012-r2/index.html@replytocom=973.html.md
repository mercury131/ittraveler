...
 
 
Related posts:Изменение UPN суффикса в Active Directory через PowershellУстановка и настройка AnsibleСоздание пользователей Active Directory через CSV файл
