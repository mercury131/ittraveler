...
 
 
Related posts:Переход на репликацию SYSVOL по DFSОтключение Skype UI в Lync 2013Автоматизация создания адресных книг в Office 365 через Powershell Часть 1.
