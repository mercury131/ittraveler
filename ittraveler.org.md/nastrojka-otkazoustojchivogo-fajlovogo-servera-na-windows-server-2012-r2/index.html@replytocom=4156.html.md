...
&nbsp;
&nbsp;
Related posts:Сброс пароля компьютера в домене без перезагрузкиОбновление схемы Active DirectoryКак узнать WWN (World Wide Name)  в Windows Server 2012R2
