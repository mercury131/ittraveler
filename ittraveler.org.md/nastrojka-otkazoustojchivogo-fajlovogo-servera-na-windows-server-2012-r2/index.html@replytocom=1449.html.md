...
&nbsp;
&nbsp;
Related posts:Настройка растянутого кластера (stretch-cluster) на Windows server 2016Новые компьютеры не появляются на WSUS сервереОтключение Skype UI в Lync 2013
