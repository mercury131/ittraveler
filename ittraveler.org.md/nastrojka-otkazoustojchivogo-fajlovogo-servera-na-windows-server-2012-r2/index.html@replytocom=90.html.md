...
 
 
Related posts:Экспорт почтовых ящиков Exchange 2010 через Powershell и PSTАктивируем LDAP over SSLАудит DNS серверов на Windows Server 2008 R2 через Powershell
