...
&nbsp;
&nbsp;
Related posts:Перенос базы данных Active DirectoryСброс пароля компьютера в домене без перезагрузкиПринудительная синхронизация Office 365 и локальной Active Directory
