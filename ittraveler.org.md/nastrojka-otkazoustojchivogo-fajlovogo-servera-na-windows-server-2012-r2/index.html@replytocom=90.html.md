...
&nbsp;
&nbsp;
Related posts:Передача и захват ролей FSMOСоздание email рассылки через PowershellАвтоматизация создания адресных книг в Office 365 через Powershell Часть 3.
