...
&nbsp;
&nbsp;
Related posts:Создание email рассылки через PowershellПеренос базы данных Active DirectoryАвтоматизация создания адресных книг в Office 365 через Powershell Часть 3.
