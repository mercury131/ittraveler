...
&nbsp;
&nbsp;
Related posts:Получаем MD5 файла или переменной в PowershellСброс настроек GPO на стандартныеПереход на репликацию SYSVOL по DFS
...
Может я чего-то упускаю?
		...
		Добавить комментарий для denz Отменить ответВаш адрес email не будет опубликован.Комментарий Имя 
Email 
Сайт 
