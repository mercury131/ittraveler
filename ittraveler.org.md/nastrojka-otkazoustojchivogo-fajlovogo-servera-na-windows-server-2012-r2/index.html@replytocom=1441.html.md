...
&nbsp;
&nbsp;
Related posts:Автоматический перенос старых перемещаемых профилей в архив с помощью Powershell.Настройка Kerberos авторизации в Apache2Аудит доменных служб Active Directory в Windows Server 2008 R2
