...
&nbsp;
&nbsp;
Related posts:Поиск старых почтовых ящиков в Exchange 2010Аудит незаполненных полей в Active Directory через PowershellНазначение служб для сертификатов Exchange через Powershell.
