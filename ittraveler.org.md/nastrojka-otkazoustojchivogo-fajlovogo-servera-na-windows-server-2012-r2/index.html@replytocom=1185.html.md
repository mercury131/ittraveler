...
 
 
Related posts:Сброс пароля администратора Active DirectoryСброс настроек GPO на стандартныеАудит DNS серверов на Windows Server 2008 R2 через Powershell
