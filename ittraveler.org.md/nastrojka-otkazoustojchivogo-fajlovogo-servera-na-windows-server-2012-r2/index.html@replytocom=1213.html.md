...
&nbsp;
&nbsp;
Related posts:Автоматизация создания адресных книг в Office 365 через Powershell Часть 3.Активируем LDAP over SSLАудит DNS серверов на Windows Server 2008 R2 через Powershell
