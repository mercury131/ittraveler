...
 
 
Related posts:Переход на репликацию SYSVOL по DFSАудит изменений групповых политик через PowerShellУдаляем неисправный контроллер домена при помощи утилиты NTDSUTIL
