...
&nbsp;
&nbsp;
Related posts:Аудит незаполненных полей в Active Directory через PowershellWindows WSL подключение к сетевым шарамНастройка Kerberos авторизации в Apache2
