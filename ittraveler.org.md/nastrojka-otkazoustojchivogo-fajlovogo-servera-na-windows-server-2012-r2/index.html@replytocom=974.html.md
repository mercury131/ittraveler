...
 
 
Related posts:Установка и настройка AnsibleActive Directory + Thunderbird = Общая адресная книгаАудит незаполненных полей в Active Directory через Powershell
