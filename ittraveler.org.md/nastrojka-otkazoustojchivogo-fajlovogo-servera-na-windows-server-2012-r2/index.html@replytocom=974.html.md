...
&nbsp;
&nbsp;
Related posts:Ошибка Database Mirroring login attempt by user ‘Domain\user.’ failed with error: ‘Connection handsh...Аудит изменений в Active DirectoryКак узнать WWN (World Wide Name)  в Windows Server 2012R2
