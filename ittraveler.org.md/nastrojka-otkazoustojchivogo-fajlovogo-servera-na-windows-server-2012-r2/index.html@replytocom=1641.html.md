...
&nbsp;
&nbsp;
Related posts:Active Directory + Thunderbird = Общая адресная книгаАудит незаполненных полей в Active Directory через PowershellСоздание email рассылки через Powershell
