...
&nbsp;
&nbsp;
Related posts:Установка и настройка Lync 2013Подключение к Office 365 через Powershell и зашифрованный парольДобавление почтовых контактов в Office 365 через Powershell и CSV
