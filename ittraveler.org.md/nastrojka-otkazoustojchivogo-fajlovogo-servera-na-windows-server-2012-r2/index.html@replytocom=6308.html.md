...
&nbsp;
&nbsp;
Related posts:Принудительная синхронизация контроллеров домена Active DirectoryАвтоматический аудит компьютеров в Active Directory через powershell.Включение корзины Active Directory
