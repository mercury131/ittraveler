...
&nbsp;
&nbsp;
Related posts:Переход на репликацию SYSVOL по DFSСброс пароля администратора Active DirectoryАудит незаполненных полей в Active Directory через Powershell
