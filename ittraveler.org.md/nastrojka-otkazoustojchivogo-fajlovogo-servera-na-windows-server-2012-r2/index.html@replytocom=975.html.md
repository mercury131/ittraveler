...
&nbsp;
&nbsp;
Related posts:Включение корзины Active DirectoryУправление репликацией Active DirectoryУдаляем неисправный контроллер домена при помощи утилиты NTDSUTIL
