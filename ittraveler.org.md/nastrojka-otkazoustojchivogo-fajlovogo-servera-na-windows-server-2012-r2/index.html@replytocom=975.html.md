...
 
 
Related posts:Аудит изменений в Active DirectoryПередача и захват ролей FSMOАвтоматизация создания адресных книг в Office 365 через Powershell Часть 2
