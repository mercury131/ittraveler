...
 
 
Related posts:Удаляем неисправный контроллер домена при помощи утилиты NTDSUTILОтключение Skype UI в Lync 2013Аудит DNS серверов на Windows Server 2008 R2 через Powershell
