...
 
 
Related posts:Перенос виртуальной машины из Hyper-V в Proxmox (KVM)Аудит DNS серверов на Windows Server 2008 R2 через PowershellПолучаем MD5 файла или переменной в Powershell
