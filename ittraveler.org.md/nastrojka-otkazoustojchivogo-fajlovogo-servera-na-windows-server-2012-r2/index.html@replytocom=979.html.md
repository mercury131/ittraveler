...
 
 
Related posts:Настройка HA кластера Hyper-VНазначение служб для сертификатов Exchange через Powershell.Active Directory + Thunderbird = Общая адресная книга
