...
&nbsp;
&nbsp;
Related posts:Передача и захват ролей FSMOВключение корзины Active DirectoryАвтоматизация создания адресных книг в Office 365 через Powershell Часть 3.
