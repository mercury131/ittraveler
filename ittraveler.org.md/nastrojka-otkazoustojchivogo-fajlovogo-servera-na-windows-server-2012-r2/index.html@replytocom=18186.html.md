...
 
 
Related posts:Удаляем неисправный контроллер домена при помощи утилиты NTDSUTILНастройка Kerberos авторизации в Apache2Аудит доменных служб Active Directory в Windows Server 2008 R2
