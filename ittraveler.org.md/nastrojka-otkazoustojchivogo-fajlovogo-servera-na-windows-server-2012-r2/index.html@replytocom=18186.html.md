...
&nbsp;
&nbsp;
Related posts:Создание шаблонов Zabbix для Windows.Получаем MD5 файла или переменной в PowershellАудит DNS серверов на Windows Server 2008 R2 через Powershell
