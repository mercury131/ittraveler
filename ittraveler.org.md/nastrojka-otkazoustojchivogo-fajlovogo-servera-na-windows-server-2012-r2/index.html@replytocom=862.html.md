...
 
 
Related posts:Аудит изменений в Active DirectoryActive Directory + Thunderbird = Общая адресная книгаАудит незаполненных полей в Active Directory через Powershell
