...
&nbsp;
&nbsp;
Related posts:Обновление Lync 2013 до Skype for BusinessАудит изменений групповых политик через PowerShellКастомизация гостевых ОС Windows в KVM на примере Proxmox
