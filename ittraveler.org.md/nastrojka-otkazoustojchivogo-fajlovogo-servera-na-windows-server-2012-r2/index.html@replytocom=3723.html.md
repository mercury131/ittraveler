...
 
 
Related posts:Сброс пароля компьютера в домене без перезагрузкиActive Directory + Thunderbird = Общая адресная книгаПолучаем MD5 файла или переменной в Powershell
