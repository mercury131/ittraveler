...
 
 
Related posts:Аудит незаполненных полей в Active Directory через PowershellУдаление Lync Server 2013Аудит DNS серверов на Windows Server 2008 R2 через Powershell
