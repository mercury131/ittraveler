...
Удачной установки!
&nbsp;
Related posts:Назначение служб для сертификатов Exchange через Powershell.Настройка отказоустойчивого файлового сервера на Windows Server 2012 R2Установка и настройка кластера MSSQL 2012.
