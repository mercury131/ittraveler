...
Удачной установки!
&nbsp;
Related posts:Передача и захват ролей FSMOСброс пароля компьютера в домене без перезагрузкиНастройка растянутого кластера (stretch-cluster) на Windows server 2016
