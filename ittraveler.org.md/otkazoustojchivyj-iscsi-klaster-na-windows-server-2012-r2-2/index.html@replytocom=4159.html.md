...
Удачной установки!
 
Related posts:Создание email рассылки через PowershellАвтоматизируем бэкап баз данных MSSQL ExpressАудит DNS серверов на Windows Server 2008 R2 через Powershell
