...
Удачной установки!
 
Related posts:Создание email рассылки через PowershellОбновление схемы Active DirectoryАвтоматический аудит компьютеров в Active Directory через powershell.
