...
Удачной установки!
 
Related posts:Установка и настройка Lync 2013Создание email рассылки через PowershellУдаляем неисправный контроллер домена при помощи утилиты NTDSUTIL
