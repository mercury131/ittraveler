...
Удачной установки!
 
Related posts:Создание пользователей Active Directory через CSV файлУстановка RSAT на Windows 10 1809Аудит DNS серверов на Windows Server 2008 R2 через Powershell
