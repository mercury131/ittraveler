...
Удачной установки!
 
Related posts:Назначение служб для сертификатов Exchange через Powershell.Автоматический аудит компьютеров в Active Directory через powershell.Сброс настроек GPO на стандартные
