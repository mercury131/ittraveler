...
Удачной установки!
&nbsp;
Related posts:Автоматическая активация пользователей Lync через PowershellУстановка и настройка кластера MSSQL 2012.Принудительная синхронизация контроллеров домена Active Directory
