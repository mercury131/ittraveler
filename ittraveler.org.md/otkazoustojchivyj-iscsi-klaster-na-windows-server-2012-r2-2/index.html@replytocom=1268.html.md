...
Удачной установки!
&nbsp;
Related posts:Добавление UPN суффикса в Active DirectoryНастройка отказоустойчивого файлового сервера на Windows Server 2012 R2Автоматический аудит компьютеров в Active Directory через powershell.
