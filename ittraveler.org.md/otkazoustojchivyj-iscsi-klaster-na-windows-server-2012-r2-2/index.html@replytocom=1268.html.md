...
Удачной установки!
&nbsp;
Related posts:Назначение служб для сертификатов Exchange через Powershell.Управление репликацией Active DirectoryАудит доменных служб Active Directory в Windows Server 2008 R2
