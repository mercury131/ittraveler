...
Удачной установки!
&nbsp;
Related posts:Автоматический аудит компьютеров в Active Directory через powershell.Сброс настроек GPO на стандартныеПереход на репликацию SYSVOL по DFS
