...
Удачной установки!
 
Related posts:Назначение служб для сертификатов Exchange через Powershell.Перенос виртуальной машины из Hyper-V в Proxmox (KVM)Передача и захват ролей FSMO
