...
Удачной установки!
 
Related posts:Аудит DNS серверов на Windows Server 2008 R2 через PowershellОбновление Lync 2013 до Skype for BusinessНазначение служб для сертификатов Exchange через Powershell.
