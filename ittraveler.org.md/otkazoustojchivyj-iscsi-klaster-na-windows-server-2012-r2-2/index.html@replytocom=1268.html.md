...
Удачной установки!
&nbsp;
Related posts:Включение корзины Active DirectoryСоздание email рассылки через PowershellАвтоматический аудит компьютеров в Active Directory через powershell.
