...
Удачной установки!
 
Related posts:Установка и настройка Lync 2013Принудительная синхронизация контроллеров домена Active DirectoryНовые компьютеры не появляются на WSUS сервере
