...
Удачной установки!
 
Related posts:Автоматизируем бэкап баз данных MSSQL ExpressСброс пароля администратора Active DirectoryСоздание пользователей Active Directory через CSV файл
