...
Удачной установки!
 
Related posts:Установка и настройка дедупликации  на Windows Server 2012 R2Передача и захват ролей FSMOСоздание пользователей Active Directory через CSV файл
