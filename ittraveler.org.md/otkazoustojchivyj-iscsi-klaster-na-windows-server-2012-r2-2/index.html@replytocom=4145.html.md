...
Удачной установки!
 
Related posts:Как узнать WWN (World Wide Name)  в Windows Server 2012R2Перенос базы данных Active DirectoryАвтоматическая активация пользователей Lync через Powershell
