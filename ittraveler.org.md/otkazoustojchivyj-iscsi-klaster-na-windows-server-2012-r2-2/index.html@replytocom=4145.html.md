...
Удачной установки!
 
Related posts:Отключение Skype UI в Lync 2013Получаем MD5 файла или переменной в PowershellНазначение служб для сертификатов Exchange через Powershell.
