...
Удачной установки!
&nbsp;
Related posts:Создание шаблонов Zabbix для Windows.Создание пользователей Active Directory через CSV файлКак узнать WWN (World Wide Name)  в Windows Server 2012R2
