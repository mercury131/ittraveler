...
Удачной установки!
 
Related posts:Установка и настройка AnsibleАвтоматизируем бэкап баз данных MSSQL ExpressУдаляем неисправный контроллер домена при помощи утилиты NTDSUTIL
