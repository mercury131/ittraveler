...
Удачной установки!
 
Related posts:Аудит DNS серверов на Windows Server 2008 R2 через PowershellПринудительная синхронизация контроллеров домена Active DirectoryПередача и захват ролей FSMO
