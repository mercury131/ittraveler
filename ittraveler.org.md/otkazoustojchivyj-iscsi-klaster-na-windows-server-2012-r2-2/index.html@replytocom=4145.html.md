...
Удачной установки!
 
Related posts:Автоматическая активация пользователей Lync через PowershellСоздание email рассылки через PowershellСоздание пользователей Active Directory через CSV файл
