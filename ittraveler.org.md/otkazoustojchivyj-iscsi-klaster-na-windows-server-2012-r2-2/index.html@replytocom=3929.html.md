...
Удачной установки!
&nbsp;
Related posts:Сброс пароля администратора Active DirectoryWindows WSL подключение к сетевым шарамНастройка растянутого кластера (stretch-cluster) на Windows server 2016
