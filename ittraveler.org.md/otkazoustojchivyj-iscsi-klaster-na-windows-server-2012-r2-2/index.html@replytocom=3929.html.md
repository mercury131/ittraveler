...
Удачной установки!
&nbsp;
Related posts:Настройка отказоустойчивого файлового сервера на Windows Server 2012 R2Подключение к Office 365 через Powershell и зашифрованный парольНастройка HA кластера Hyper-V
