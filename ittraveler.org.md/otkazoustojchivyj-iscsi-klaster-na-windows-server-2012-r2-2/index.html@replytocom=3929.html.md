...
Удачной установки!
&nbsp;
Related posts:Аудит незаполненных полей в Active Directory через PowershellПеренос базы данных Active DirectoryАвтоматическая активация пользователей Lync через Powershell
