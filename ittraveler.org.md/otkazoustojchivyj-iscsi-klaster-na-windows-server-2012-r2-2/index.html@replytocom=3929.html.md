...
Удачной установки!
&nbsp;
Related posts:Переход на репликацию SYSVOL по DFSПодключение к Office 365 через Powershell и зашифрованный парольНастройка отказоустойчивого файлового сервера на Windows Server 2012 R2
