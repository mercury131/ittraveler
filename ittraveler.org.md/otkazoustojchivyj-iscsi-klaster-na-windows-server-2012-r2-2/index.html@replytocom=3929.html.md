...
Удачной установки!
&nbsp;
Related posts:Создание пользователей Active Directory через CSV файлДобавление UPN суффикса в Active DirectoryПринудительная синхронизация контроллеров домена Active Directory
