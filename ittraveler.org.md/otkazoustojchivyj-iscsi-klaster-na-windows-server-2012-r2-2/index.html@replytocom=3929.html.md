...
Удачной установки!
 
Related posts:Установка и настройка дедупликации  на Windows Server 2012 R2Автоматизируем бэкап баз данных MSSQL ExpressНовые компьютеры не появляются на WSUS сервере
