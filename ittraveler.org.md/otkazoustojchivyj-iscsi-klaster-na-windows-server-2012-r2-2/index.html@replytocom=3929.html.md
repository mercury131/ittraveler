...
Удачной установки!
&nbsp;
Related posts:Установка и настройка дедупликации  на Windows Server 2012 R2Аудит DNS серверов на Windows Server 2008 R2 через PowershellПередача и захват ролей FSMO
