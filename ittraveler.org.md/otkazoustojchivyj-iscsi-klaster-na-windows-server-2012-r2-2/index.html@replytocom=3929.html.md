...
Удачной установки!
&nbsp;
Related posts:Настройка отказоустойчивого файлового сервера на Windows Server 2012 R2Создание email рассылки через PowershellСоздание пользователей Active Directory через CSV файл
