...
Удачной установки!
&nbsp;
Related posts:Автоматическая активация пользователей Lync через PowershellАудит доменных служб Active Directory в Windows Server 2008 R2Windows WSL подключение к сетевым шарам
