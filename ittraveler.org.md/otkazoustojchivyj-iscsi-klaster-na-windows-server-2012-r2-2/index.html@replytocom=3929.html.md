...
Удачной установки!
 
Related posts:Добавление почтовых контактов в Office 365 через Powershell и CSVНастройка HA кластера Hyper-VНазначение служб для сертификатов Exchange через Powershell.
