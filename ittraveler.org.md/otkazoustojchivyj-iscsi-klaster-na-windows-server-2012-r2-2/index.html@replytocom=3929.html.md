...
Удачной установки!
&nbsp;
Related posts:Active Directory + Thunderbird = Общая адресная книгаСоздание шаблонов Zabbix для Windows.Аудит незаполненных полей в Active Directory через Powershell
