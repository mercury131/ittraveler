...
Related posts:Установка и настройка Foreman + PuppetПеренос виртуальной машины из Hyper-V в Proxmox (KVM)LVM Добавляем место на диске в виртуальной среде
