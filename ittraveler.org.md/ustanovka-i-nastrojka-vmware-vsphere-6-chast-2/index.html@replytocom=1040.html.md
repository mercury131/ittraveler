...
Related posts:QEMU/KVM проброс физического диска гипевизора в виртуальную машинуУстановка и настройка Citrix XenServer Часть 3.LVM Добавляем место на диске в виртуальной среде
