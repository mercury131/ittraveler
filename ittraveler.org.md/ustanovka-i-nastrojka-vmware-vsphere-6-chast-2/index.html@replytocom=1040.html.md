...
Related posts:Установка и настройка Citrix XenServer Часть 2.Выполняем команды внутри гостевых ОС через PowerCLIQEMU/KVM проброс физического диска гипевизора в виртуальную машину
