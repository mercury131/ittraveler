...
Related posts:Выполняем команды внутри гостевых ОС через PowerCLIУстановка и настройка Citrix XenServer Часть 4.LVM переезд с диска на диск в виртуальной среде.
