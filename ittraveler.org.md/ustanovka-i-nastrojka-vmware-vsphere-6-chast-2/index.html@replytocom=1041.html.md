...
Related posts:LVM Добавляем место на диске в виртуальной средеКастомизация гостевых ОС Windows в KVM на примере ProxmoxQEMU/KVM проброс физического диска гипевизора в виртуальную машину
