...
Related posts:LVM Добавляем место на диске в виртуальной средеУстановка и настройка VMWare Vsphere 6. Часть 3Выполняем команды внутри гостевых ОС через PowerCLI
