...
Related posts:Установка и настройка Citrix XenServer Часть 1.QEMU/KVM проброс физического диска гипевизора в виртуальную машинуLVM переезд с диска на диск в виртуальной среде.
