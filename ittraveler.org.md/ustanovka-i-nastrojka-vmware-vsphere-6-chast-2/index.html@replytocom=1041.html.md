...
Related posts:Vsphere. Поиск виртуальных машин с толстыми дискамиВыполняем команды внутри гостевых ОС через PowerCLIКастомизация гостевых ОС Windows в KVM на примере Proxmox
