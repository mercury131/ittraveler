...
Related posts:Установка и настройка Citrix XenServer Часть 1.Vsphere. Поиск виртуальных машин с толстыми дискамиLVM переезд с диска на диск в виртуальной среде.
