...
Related posts:Выполняем команды внутри гостевых ОС через PowerCLIУстановка и настройка Citrix XenServer Часть 1.LVM переезд с диска на диск в виртуальной среде.
