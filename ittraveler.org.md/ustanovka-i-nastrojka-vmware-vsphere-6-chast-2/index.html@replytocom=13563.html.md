...
Related posts:LVM Добавляем место на диске в виртуальной средеУстановка и настройка VMWare Vsphere 6. Часть 4Выполняем команды внутри гостевых ОС через PowerCLI
