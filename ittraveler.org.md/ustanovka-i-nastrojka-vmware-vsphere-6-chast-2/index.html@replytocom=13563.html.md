...
Related posts:Установка и настройка Citrix XenServer Часть 3.LVM Добавляем место на диске в виртуальной средеВыполняем команды внутри гостевых ОС через PowerCLI
