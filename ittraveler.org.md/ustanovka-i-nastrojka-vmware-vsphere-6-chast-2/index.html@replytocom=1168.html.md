...
Related posts:LVM Добавляем место на диске в виртуальной средеVsphere. Поиск виртуальных машин с толстыми дискамиLVM переезд с диска на диск в виртуальной среде.
