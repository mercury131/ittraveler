...
Related posts:Установка и настройка Citrix XenServer Часть 4.QEMU/KVM проброс физического диска гипевизора в виртуальную машинуВыполняем команды внутри гостевых ОС через PowerCLI
