...
Related posts:Выполняем команды внутри гостевых ОС через PowerCLIУстановка и настройка Citrix XenServer Часть 3.LVM Добавляем место на диске в виртуальной среде
