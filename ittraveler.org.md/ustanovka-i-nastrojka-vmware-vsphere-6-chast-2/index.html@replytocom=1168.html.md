...
Related posts:Установка и настройка Citrix XenServer Часть 3.Vsphere. Поиск виртуальных машин с толстыми дискамиВыполняем команды внутри гостевых ОС через PowerCLI
