...
Related posts:Установка и настройка Citrix XenServer Часть 2.Выполняем команды внутри гостевых ОС через PowerCLILVM переезд с диска на диск в виртуальной среде.
