...
Related posts:LVM переезд с диска на диск в виртуальной среде.LVM Добавляем место на диске в виртуальной средеВыполняем команды внутри гостевых ОС через PowerCLI
