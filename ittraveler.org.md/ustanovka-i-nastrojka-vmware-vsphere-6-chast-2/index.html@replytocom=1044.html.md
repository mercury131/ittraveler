...
Related posts:LVM переезд с диска на диск в виртуальной среде.Установка и настройка Citrix XenServer Часть 2.Установка и настройка VMWare Vsphere 6. Часть 1.
