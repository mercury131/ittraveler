...
Related posts:Выполняем команды внутри гостевых ОС через PowerCLILVM Добавляем место на диске в виртуальной средеУстановка и настройка Citrix XenServer Часть 3.
