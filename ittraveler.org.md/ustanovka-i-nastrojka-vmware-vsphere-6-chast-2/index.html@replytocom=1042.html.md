...
Related posts:LVM переезд с диска на диск в виртуальной среде.Установка и настройка VMWare Vsphere 6. Часть 3Выполняем команды внутри гостевых ОС через PowerCLI
