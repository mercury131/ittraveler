...
Related posts:Установка и настройка Citrix XenServer Часть 1.LVM переезд с диска на диск в виртуальной среде.LVM Добавляем место на диске в виртуальной среде
