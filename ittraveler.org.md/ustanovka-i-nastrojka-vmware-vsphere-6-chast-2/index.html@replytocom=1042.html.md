...
Related posts:LVM переезд с диска на диск в виртуальной среде.LVM Добавляем место на диске в виртуальной средеУстановка и настройка Citrix XenServer Часть 3.
