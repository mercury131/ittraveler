...
Related posts:Выполняем команды внутри гостевых ОС через PowerCLIУстановка и настройка VMWare Vsphere 6. Часть 3LVM Добавляем место на диске в виртуальной среде
