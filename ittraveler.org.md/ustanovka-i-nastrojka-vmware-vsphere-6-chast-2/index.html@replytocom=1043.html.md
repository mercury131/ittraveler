...
Related posts:Vsphere. Поиск виртуальных машин с толстыми дискамиВыполняем команды внутри гостевых ОС через PowerCLIQEMU/KVM проброс физического диска гипевизора в виртуальную машину
