...
Related posts:Установка и настройка Citrix XenServer Часть 3.Перенос виртуальной машины из Hyper-V в Proxmox (KVM)LVM Добавляем место на диске в виртуальной среде
