...
Related posts:Установка и настройка Citrix XenServer Часть 3.Установка и настройка Citrix XenServer Часть 1.Выполняем команды внутри гостевых ОС через PowerCLI
