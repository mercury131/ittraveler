...
Related posts:Установка и настройка Citrix XenServer Часть 1.Установка и настройка VMWare Vsphere 6. Часть 4LVM переезд с диска на диск в виртуальной среде.
