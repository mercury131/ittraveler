...
Related posts:Кастомизация гостевых ОС Windows в KVM на примере ProxmoxУстановка и настройка VMWare Vsphere 6. Часть 4LVM переезд с диска на диск в виртуальной среде.
