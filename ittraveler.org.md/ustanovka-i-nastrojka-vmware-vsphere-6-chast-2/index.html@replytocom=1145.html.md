...
Related posts:Vsphere. Поиск виртуальных машин с толстыми дискамиУстановка и настройка Citrix XenServer Часть 2.LVM переезд с диска на диск в виртуальной среде.
