...
Related posts:Установка и настройка Citrix XenServer Часть 1.LVM Добавляем место на диске в виртуальной средеКастомизация гостевых ОС Windows в KVM на примере Proxmox
