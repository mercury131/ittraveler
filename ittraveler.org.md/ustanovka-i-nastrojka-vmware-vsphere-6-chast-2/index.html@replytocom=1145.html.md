...
Related posts:Запуск команд внутри гостевых ОС в гипервизоре KVM на примере ProxmoxУстановка и настройка VMWare Vsphere 6. Часть 3LVM переезд с диска на диск в виртуальной среде.
