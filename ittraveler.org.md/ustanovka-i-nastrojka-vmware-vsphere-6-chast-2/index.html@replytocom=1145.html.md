...
Related posts:Установка и настройка Citrix XenServer Часть 3.LVM переезд с диска на диск в виртуальной среде.Установка и настройка VMWare Vsphere 6. Часть 1.
