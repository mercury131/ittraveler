...
Related posts:LVM переезд с диска на диск в виртуальной среде.Установка и настройка VMWare Vsphere 6. Часть 3LVM Добавляем место на диске в виртуальной среде
