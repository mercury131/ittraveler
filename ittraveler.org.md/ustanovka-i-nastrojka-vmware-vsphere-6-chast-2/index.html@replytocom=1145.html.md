...
Related posts:Выполняем команды внутри гостевых ОС через PowerCLIПеренос виртуальной машины из Hyper-V в Proxmox (KVM)LVM Добавляем место на диске в виртуальной среде
