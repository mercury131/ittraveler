...
Related posts:Кастомизация гостевых ОС Windows в KVM на примере ProxmoxLVM Добавляем место на диске в виртуальной средеПеренос виртуальной машины из Hyper-V в Proxmox (KVM)
