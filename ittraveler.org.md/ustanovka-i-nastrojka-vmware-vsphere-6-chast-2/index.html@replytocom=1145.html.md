...
Related posts:QEMU/KVM проброс физического диска гипевизора в виртуальную машинуНастройка HA кластера Hyper-VLVM переезд с диска на диск в виртуальной среде.
