...
&nbsp;
&nbsp;
Related posts:Запуск команд внутри гостевых ОС в гипервизоре KVM на примере ProxmoxKVM восстановление qcow2 дискаLVM Добавляем место на диске в виртуальной среде
