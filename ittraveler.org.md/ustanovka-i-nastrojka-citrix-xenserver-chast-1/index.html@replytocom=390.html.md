...
&nbsp;
&nbsp;
Related posts:Установка и настройка VMWare Vsphere 6. Часть 4LVM Добавляем место на диске в виртуальной средеВыполняем команды внутри гостевых ОС через PowerCLI
