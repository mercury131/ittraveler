...
&nbsp;
&nbsp;
Related posts:Выполняем команды внутри гостевых ОС через PowerCLIУстановка и настройка VMWare Vsphere 6. Часть 2LVM Добавляем место на диске в виртуальной среде
