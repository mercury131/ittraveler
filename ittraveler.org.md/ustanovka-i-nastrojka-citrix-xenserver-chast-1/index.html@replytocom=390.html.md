...
 
 
Related posts:Установка и настройка Citrix XenServer Часть 3.LVM переезд с диска на диск в виртуальной среде.Выполняем команды внутри гостевых ОС через PowerCLI
