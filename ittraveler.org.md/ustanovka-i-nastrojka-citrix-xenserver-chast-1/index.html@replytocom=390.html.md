...
&nbsp;
&nbsp;
Related posts:Установка и настройка Citrix XenServer Часть 4.Установка и настройка VMWare Vsphere 6. Часть 5Выполняем команды внутри гостевых ОС через PowerCLI
