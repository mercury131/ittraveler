...
&nbsp;
&nbsp;
Related posts:KVM восстановление qcow2 дискаВыполняем команды внутри гостевых ОС через PowerCLIКастомизация гостевых ОС Windows в KVM на примере Proxmox
