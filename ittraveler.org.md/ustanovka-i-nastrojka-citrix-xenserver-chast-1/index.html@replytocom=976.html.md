...
&nbsp;
&nbsp;
Related posts:Кастомизация гостевых ОС Windows в KVM на примере ProxmoxУстановка и настройка Citrix XenServer Часть 4.LVM Добавляем место на диске в виртуальной среде
