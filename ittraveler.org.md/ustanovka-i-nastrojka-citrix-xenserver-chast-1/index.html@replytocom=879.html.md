...
&nbsp;
&nbsp;
Related posts:Выполняем команды внутри гостевых ОС через PowerCLILVM Добавляем место на диске в виртуальной средеVsphere. Поиск виртуальных машин с толстыми дисками
