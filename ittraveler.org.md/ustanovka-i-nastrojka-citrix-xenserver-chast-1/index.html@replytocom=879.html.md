...
&nbsp;
&nbsp;
Related posts:Установка и настройка VMWare Vsphere 6. Часть 2LVM переезд с диска на диск в виртуальной среде.Выполняем команды внутри гостевых ОС через PowerCLI
