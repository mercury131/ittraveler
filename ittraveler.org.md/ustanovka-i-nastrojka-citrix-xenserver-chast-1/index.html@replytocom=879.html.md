...
&nbsp;
&nbsp;
Related posts:Vsphere. Поиск виртуальных машин с толстыми дискамиВыполняем команды внутри гостевых ОС через PowerCLIУстановка и настройка VMWare Vsphere 6. Часть 3
